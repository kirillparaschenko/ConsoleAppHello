...
namespace ConsoleAppHello.HomeTasks.HomeWork7.Public_transport_park
{
    ...
    {
        public Tramcar(string number, string endStation, string departureTime, int seats) : base(number, endStation, departureTime, seats)
        {
        }
        ...
        {
            Console.WriteLine($"Tramcar: {Number}, {DepartureTime}, {EndStation}, {Seats}");
        }

        public override void TransportType()
        {
            Console.WriteLine("Rail Tramcar");
        }
    }
}
